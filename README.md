...
```
git clone https://github.com/seabearlmx/MFR.git
cd MFR
```
Install following packages.
```
conda create --name mfr python=3.7
conda activate mfr
...
3. You can train MFR with following commands.
```
<path_to_MFR>$ CUDA_VISIBLE_DEVICES=0,1,2,3 ./scripts/train_r50os16_gtav_ibn.sh # Train: GTAV, Test: BDD100K, Cityscapes, Synthia, Mapillary / ResNet50
```

4. You can validate model with following commands.
```
<path_to_MFR>$ CUDA_VISIBLE_DEVICES=0,1,2,3 ./scripts/valid_r50os16_gtav_ibn.sh <weight_file_location>
```
